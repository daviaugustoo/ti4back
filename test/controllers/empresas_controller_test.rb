...
class EmpresasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create empresa" do
    assert_difference("Empresa.count") do
      post empresas_url, params: { empresa: { cnpj: @empresa.cnpj, contato: @empresa.contato, nome: @empresa.nome } }, as: :json
    end
  ...
  test "should update empresa" do
    patch empresa_url(@empresa), params: { empresa: { cnpj: @empresa.cnpj, contato: @empresa.contato, nome: @empresa.nome } }, as: :json
    assert_response :success
  end
